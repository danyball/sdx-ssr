...
const BUILD = /* stencil-starter-project-name */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: true, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: true, constructableCSS: false, cssAnnotations: true, devTools: false, disconnectedCallback: true, element: false, event: true, hasRenderFn: true, hostListener: true, hostListenerTarget: true, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: true, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, patchPseudoShadowDom: false, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: false, propString: true, reflect: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: true };
...
const tabsCss = "/*!@:host,\n*,\n*:before,\n*:after*/.sc-sdx-tabs-h,*.sc-sdx-tabs,*.sc-sdx-tabs:before,*.sc-sdx-tabs:after{box-sizing:border-box}/*!@.button-reset*/.button-reset.sc-sdx-tabs{font-family:TheSans, sans-serif;font-weight:500;line-height:24px;letter-spacing:-0.1px;font-size:18px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;vertical-align:middle;text-decoration:none;text-align:center;color:inherit;margin:0;transition:all 150ms cubic-bezier(0.4, 0, 0.6, 1);-webkit-tap-highlight-color:transparent;white-space:unset;padding:unset;border:none;background:transparent;user-select:none}/*!@.button-reset:focus*/.button-reset.sc-sdx-tabs:focus{outline:0}/*!@.button-reset:not(:disabled)*/.button-reset.sc-sdx-tabs:not(:disabled){cursor:pointer}/*!@.button-reset::-moz-focus-inner*/.button-reset.sc-sdx-tabs::-moz-focus-inner{border:0}/*!@:host*/.sc-sdx-tabs-h{display:block}/*!@.component*/.component.sc-sdx-tabs{display:flex;flex-flow:column}/*!@.component.centered .header*/.component.centered.sc-sdx-tabs .header.sc-sdx-tabs{align-self:center}/*!@.component.left-aligned .header*/.component.left-aligned.sc-sdx-tabs .header.sc-sdx-tabs{align-self:flex-start}/*!@.component .header*/.component.sc-sdx-tabs .header.sc-sdx-tabs{background:#eef3f6;border-radius:12px;max-width:100%;align-self:flex-start}/*!@.component .header .tablist*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs{position:relative;list-style-type:none;margin:0;white-space:nowrap}/*!@.component .header .tablist .indicator*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .indicator.sc-sdx-tabs{position:absolute;width:114px;top:0;bottom:0;background-color:#015;border-radius:12px}@media (min-width: 768px){/*!@.component .header .tablist .indicator*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .indicator.sc-sdx-tabs{width:178px}}/*!@.component .header .tablist .clickable*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs{cursor:pointer;min-width:114px;max-width:248px;padding:12px 24px;position:relative}@media (min-width: 768px){/*!@.component .header .tablist .clickable*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs{padding:12px 48px;min-width:178px;max-width:312px}}/*!@.component .header .tablist .clickable:is(a)*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:is(a){display:inline-block}/*!@.component .header .tablist .clickable:hover*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:hover{color:#0048cf}/*!@.component .header .tablist .clickable:disabled*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled{color:rgba(51, 51, 51, 0.4)}/*!@.component .header .tablist .clickable:disabled.disabled, .component .header .tablist .clickable:disabled:disabled*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled.disabled,.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled:disabled{cursor:not-allowed}/*!@.component .header .tablist .clickable:disabled.disabled:active, .component .header .tablist .clickable:disabled:disabled:active*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled.disabled:active,.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled:disabled:active{pointer-events:none;transform:none}/*!@.component .header .tablist .clickable.selected*/.component.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.selected.sc-sdx-tabs{color:#fff}/*!@.component .body*/.component.sc-sdx-tabs .body.sc-sdx-tabs{padding:24px 0 0}/*!@.component.sdx--dark-theme .header*/.component.sdx--dark-theme.sc-sdx-tabs .header.sc-sdx-tabs{background:#242424}/*!@.component.sdx--dark-theme .header .tablist .indicator*/.component.sdx--dark-theme.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .indicator.sc-sdx-tabs{background-color:rgba(173, 173, 173, 0.15)}/*!@.component.sdx--dark-theme .header .tablist .clickable:hover*/.component.sdx--dark-theme.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:hover{color:#5ca3ff}/*!@.component.sdx--dark-theme .header .tablist .clickable:disabled*/.component.sdx--dark-theme.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.sc-sdx-tabs:disabled{color:rgba(230, 230, 230, 0.5)}/*!@.component.sdx--dark-theme .header .tablist .clickable.selected*/.component.sdx--dark-theme.sc-sdx-tabs .header.sc-sdx-tabs .tablist.sc-sdx-tabs .clickable.selected.sc-sdx-tabs{color:#4294ff}";
...
class Tabs {
  ...
  onWindowResize() {
    ...
    this.resizeTimer = setTimeout(() => this.animateIndicatorElToSelectedTab(0), 200);
  }
  constructor(hostRef) {
  ...
  animateIndicatorElToSelectedTab(animationDuration = this.getAnimationDuration()) {
    const { tabsItemEls, selectedTabsItemEl } = this.state.get();
    if (!selectedTabsItemEl) {
    ...
    const selectedClickableEl = this.tabsItemsWithClickableEl.get(selectedTabsItemEl);
    ...
    animation.start({
      ...
      easing: "easeOutQuad",
      translateX: selectedClickableElRect.left - tablistElRect.left - scrollLeft,
  ...
  select(el, isUserInteractionInProgress = false, selectedByArrowKeys = false) {
  ...
  render() {
    ...
    return (hAsync("div", { class: this.getComponentClassNames(), ref: (el) => (this.componentEl = el) }, hAsync("div", { class: "header" }, hAsync("div", { class: "tablist", role: "tablist", "aria-label": this.srHint, ref: (el) => (this.tablistEl = el) }, hAsync("div", { class: "indicator", ref: (el) => (this.indicatorEl = el), style: {
